        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-sm opacity-80 leading-relaxed">
              Hệ thống quản lý giải đấu Bowling chuyên nghiệp. Theo dõi thống kê, xếp hạng và lịch
              thi đấu.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/fixtures" className="opacity-80 hover:opacity-100 transition-opacity">
                  Fixtures
                </Link>
              </li>
              <li>
                <Link to="/standings" className="opacity-80 hover:opacity-100 transition-opacity">
                  Standings
                </Link>
              </li>
              <li>
                <Link to="/stats" className="opacity-80 hover:opacity-100 transition-opacity">
                  Player Stats
                </Link>
              </li>
              <li>
