...
import { fetchTeams, Team } from '../../services/api.services';
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-slate-100">
                {sortedTeams.map((team, index) => (
                  <tr key={team.TeamId} className="hover:bg-blue-50/50 transition-colors group">
                    ...
                    <td className="px-6 py-4 text-center text-slate-600 font-medium">0</td>
                    <td className="px-6 py-4 text-center text-slate-600 font-medium">0</td>
                    <td className="px-6 py-4 text-center text-slate-600 font-medium">0</td>
                    <td className="px-6 py-4 text-center">
